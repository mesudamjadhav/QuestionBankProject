...
CREATE TABLE `subquestion` (
  ...
  `sub_question_desc` varchar(300) DEFAULT NULL,
  `sub_question_choice` varchar(50) DEFAULT NULL,
...
INSERT INTO `subquestion` VALUES (5,'SQ1','sc');
...
-- Dump completed on 2019-07-02 21:28:27
