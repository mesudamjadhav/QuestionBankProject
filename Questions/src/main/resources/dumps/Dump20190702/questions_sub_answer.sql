...
CREATE TABLE `sub_answer` (
  `sub_answer_id` int(11) NOT NULL AUTO_INCREMENT,
  `sub_answer_desc` varchar(300) DEFAULT NULL,
  `sub_answer_que_id` int(11) DEFAULT NULL,
...
INSERT INTO `sub_answer` VALUES (1,'SA1',5);
...
-- Dump completed on 2019-07-02 21:28:25
